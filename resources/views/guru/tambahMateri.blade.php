...
<body>
    <div class="min-h-screen bg-gray-50 p-4 md:p-8">
        ...
        <div class="mt-6 flex flex-col lg:flex-row gap-6">
            ...
            <!-- Konten Utama -->
            <form action="{{ route('tambahMateri2') }}" method="POST" class="space-y-4">
                @csrf
                <!-- Judul -->
                <div>
                    <label for="judul" class="block text-sm font-medium text-gray-600">Judul *</label>
                    <input type="text" id="judul" name="judul" placeholder="Contoh: Latihan Sebelum UTS"
                ...
                <div>
                    ...
                    <select id="topik" name="topik"
                        class="w-full mt-1 border border-gray-300 rounded-lg p-2 focus:ring-2 focus:ring-blue-500 focus:outline-none">
                        <option value="" disabled selected>Pilih Judul Bab</option>
                ...
                <div>
                    ...
                    <select id="modul" name="modul"
                        class="w-full mt-1 border border-gray-300 rounded-lg p-2 focus:ring-2 focus:ring-blue-500 focus:outline-none">
                        <option value="">Tidak dimasukkan ke dalam modul ajar</option>
                ...
                <div>
                    ...
                    <textarea id="deskripsi" name="deskripsi" placeholder="Jelaskan detail materi secara singkat dan jelas"
                ...
                <div class="flex flex-col md:flex-row justify-between gap-4 mt-6">
                    <button type="submit"
                        class="w-full md:w-auto px-6 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600">Lanjut Tambah Materi</button>
                </div>
            </form>

            @if(session('success'))
            <div class="bg-green-500 text-white text-sm px-4 py-2 rounded-md">
                {{ session('success') }}
            </div>
            @endif

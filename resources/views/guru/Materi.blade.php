    ...
    <div class="flex-1 p-9">
        ...
        <div class="mt-4">
            <select class="w-full bg-white border border-gray-300 rounded px-4 py-2">
                ...
                <option>Materi Saya</option>
                <option>Materi Publik</option>
            </select>
        </div>

        <!-- Materi Section -->
        <a href="/guru/10" class="block mt-6 bg-white rounded-lg shadow p-6 hover:bg-gray-100 transition">
    <!-- Header -->
        ...
        <div class="flex-1">
            <div class="flex justify-between items-center">
                ...
                <button class="text-gray-500 hover:text-gray-700">
                    <span class="bg-red-500 text-white px-4 py-2 rounded font-semibold hover:bg-orange-600">Hapus</span>
                </button>
            </div>
